...
final class ModuleItemPolicy
{
    ...
    public function update(User $user, ModuleItem $item): bool
    {
        return $this->canManage($user, $item->module->course);
    }

    public function delete(User $user, ModuleItem $item): bool
    {
        return $this->canManage($user, $item->module->course);
    }
