...
final class UpdateEvaluationRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'available_from' => ['nullable', 'date', new WithinCohortSchedule($this->route('evaluation')?->module?->course, $this->route('evaluation')?->available_from)],
            'available_until' => ['nullable', 'date', 'after:available_from', new WithinCohortSchedule($this->route('evaluation')?->module?->course, $this->route('evaluation')?->available_until)],
