 ...
 * enrolments) that it shouldn't be a bookmarkable, readily-stumbled-into form. The only entry
 * point is the "Bulk import" quick action on the admin dashboard, which opens this in a Modal.
 */
