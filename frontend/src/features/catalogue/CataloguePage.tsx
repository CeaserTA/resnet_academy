                    ...
                    <div className="mx-auto max-w-7xl lg:grid lg:grid-cols-2 lg:items-center">
                        ...
                        <div className="flex items-center justify-center px-6 py-12 lg:py-14">
                            ...
                            >
                                {/* Soft organic blob */}
                                <path
                                    d="M195,25 C275,5 365,55 368,145 C372,235 305,320 210,318 C115,320 32,258 28,168 C22,78 115,45 195,25Z"
                                ...
                                <g transform="translate(170,28)" strokeLinecap="round" strokeLinejoin="round">
                                    ...
                                    <text x="30" y="56" textAnchor="middle" fill="rgba(255,255,255,0.75)" fontSize="9" fontFamily="system-ui" letterSpacing="0.05em">BROWSE</text>
                                </g>
                                ...
                                <g transform="translate(298,150)" strokeLinecap="round" strokeLinejoin="round">
                                    ...
                                    <text x="24" y="56" textAnchor="middle" fill="rgba(255,255,255,0.75)" fontSize="9" fontFamily="system-ui" letterSpacing="0.05em">APPLY</text>
                                </g>
                                ...
                                <g transform="translate(170,276)" strokeLinecap="round" strokeLinejoin="round">
                                    ...
                                    <text x="30" y="56" textAnchor="middle" fill="rgba(255,255,255,0.75)" fontSize="9" fontFamily="system-ui" letterSpacing="0.05em">LEARN</text>
                                </g>
                                ...
                                <g transform="translate(58,150)" strokeLinecap="round" strokeLinejoin="round">
                                    ...
                                    <text x="24" y="56" textAnchor="middle" fill="rgba(232,163,61,0.85)" fontSize="9" fontFamily="system-ui" letterSpacing="0.05em">GRADUATE</text>
                                </g>
