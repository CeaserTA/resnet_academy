    ...
    return (
        ...
        >
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                ...
                {/* ── Tabs ── */}
                <div
                    className={`mt-10 transition-all duration-700 delay-150 ${
                        visible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-6'
                    }`}
                >
                        ...
                        <div className="inline-flex rounded-full border border-border bg-white p-1">
                            {tabs.map((tab) => (
                                <button
                                    ...
                                    className={`rounded-full px-5 py-2 text-sm font-semibold transition-colors duration-200 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary ${
                                        activeTab === tab
